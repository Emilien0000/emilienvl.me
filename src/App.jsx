...
>>>>>>> 15da9d162bde633e7124424a4f5498005a907e45
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    await login(pw);
    setPw(''); // efface toujours le champ, succès ou échec
    setSubmitting(false);
  };
...
<<<<<<< HEAD
  ...
  if (!authed) {
=======
  // Vérification du token existant en sessionStorage (au montage)
  if (loading) {
>>>>>>> 15da9d162bde633e7124424a4f5498005a907e45
    return (
      ...
      <div className="admin-center">
        ...
        >
          <h2 className="admin-title">
            Accès <span className="highlight">Admin</span>
          </h2>
  ...
  // Zone admin authentifiée — remplace ce contenu par ce que tu veux
  return (
    <motion.div
    ...
    >
      <motion.div className="admin-header" variants={itemVariants}>
        <h2 className="admin-title">
          Zone <span className="highlight">Admin</span>
        </h2>
      ...
      <motion.div className="admin-content" variants={itemVariants}>
        <p>Contenu admin accessible uniquement après authentification serveur.</p>
      </motion.div>
    </motion.div>
  );
}
